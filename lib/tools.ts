...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Converta páginas de um arquivo PDF em slides de uma apresentação PowerPoint.",
    category: "pdf",
    hubFilter: "Converter",
    badge: "PDF",
    icon: FileText,
    ...
    seoDescription:
      "Converta PDF para PowerPoint (PPTX) online e grátis. Escolha, organize e transforme páginas do PDF em slides com alta fidelidade visual.",
    keywords: [
      "pdf para powerpoint",
      "converter pdf em powerpoint",
      "pdf para pptx",
      "transformar pdf em slides",
      "conversor pdf powerpoint online",
    ],
  },
  {
    slug: "pdf-para-word",
    name: "PDF para Word",
    description:
      "Converta arquivos PDF em documentos editáveis do Word no formato DOCX.",
    category: "pdf",
    hubFilter: "Converter",
    badge: "PDF",
    icon: FileText,
    ...
    seoDescription:
      "Converta PDF para Word (DOCX) online e grátis. Transforme textos, títulos, listas e tabelas em documentos editáveis, sem instalar programas.",
    keywords: [
      "pdf para word",
      "converter pdf em word",
      "pdf para docx",
      "transformar pdf em word",
      "conversor pdf word online",
    ],
  },
  {
    slug: "word-para-pdf",
    name: "Word para PDF",
    description:
      "Converta documentos DOCX do Word em arquivos PDF diretamente no navegador.",
    category: "pdf",
    hubFilter: "Converter",
    badge: "PDF",
    icon: FileText,
    ...
    seoDescription:
      "Converta Word para PDF online e grátis. Transforme arquivos DOCX em PDF preservando textos, imagens, tabelas e formatação, sem instalar programas.",
    keywords: [
      "word para pdf",
      "converter word em pdf",
      "docx para pdf",
      "transformar word em pdf",
      "conversor word pdf online",
    ],
  },
  {
