...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Acompanhe notícias recentes de marketing, inteligência artificial e e-commerce em fontes especializadas.",
    category: "social",
    hubFilter: "Pesquisar",
    badge: "Marketing",
    icon: Radar,
    available: true,
    seoTitle: "Radar de Notícias de Marketing, IA e E-commerce | Kivai",
    seoDescription: "Acompanhe notícias recentes de marketing, inteligência artificial e e-commerce em uma seleção de fontes especializadas, com links para as publicações originais.",
    keywords: ["radar de notícias", "notícias de marketing", "notícias de inteligência artificial", "notícias de e-commerce", "acompanhamento de notícias do mercado digital"],
  },
  {
  ...
  {
    slug: "baixar-video-tiktok",
    name: "Baixar Vídeo do TikTok",
