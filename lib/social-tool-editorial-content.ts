...
export const socialAdvancedEditorialContent: Record<SocialAdvancedEditorialSlug, SocialAdvancedEditorialContent> = {
  "calendario-editorial-redes-sociais": {
    ...
    useCases: [
      { title: "Planejamento mensal", description: "Distribua pautas ao longo do mês e reduza lacunas, repetições e conflitos de publicação." },
    ...
    steps: [
      ...
      "Use os filtros para revisar equilíbrio, volume e pendências.",
