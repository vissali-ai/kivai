...
export function ArticleView({ post, preview = false, blockVisibility = {} }: { post: Post; preview?: boolean; blockVisibility?: Record<string, boolean> }) {
  ...
  const visible = (key: string) => blockVisibility[key] !== false;
