...
export function SiteServiceEditor({ initialService }: { initialService: ManagedSiteService }) {
  ...
  async function save(event: React.FormEvent) {
    ...
    setMessage("Serviço salvo. A página pública e o sitemap foram atualizados.");
