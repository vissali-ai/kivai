...
export function MediaManager({ initialMedia }: { initialMedia: Media[] }) {
  const router = useRouter(); const [editing, setEditing] = useState<Media | null>(null); const [message, setMessage] = useState(""); const [busy, setBusy] = useState(false); const [visibleCount, setVisibleCount] = useState(10);
