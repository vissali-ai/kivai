...
const links = [
  ...
  { href: "/admin/site", label: "Conteúdo do site", icon: PanelsTopLeft },
  ...
  return (
    <div className="mx-auto grid w-full max-w-[1500px] flex-1 gap-6 px-4 pb-6 pt-24 lg:grid-cols-[220px_minmax(0,1fr)] lg:px-6">
      <aside className="h-fit border border-white/10 bg-card p-4 lg:sticky lg:top-6">
        <div className="mb-5 flex items-center gap-2"><BookOpen className="text-primary" /><div><p className="font-semibold">Kivai CMS</p><p className="text-xs text-muted-foreground">Conteúdo do site</p></div></div>
