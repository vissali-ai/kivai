...
export function NewsAgentPanel({ canRun }: { canRun: boolean }) {
  ...
  async function run() {
    setRunning(true);
    setMessage("Consultando RSS, sitemaps e páginas editoriais para criar pautas em rascunho...");
    try {
