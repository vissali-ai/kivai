...
export default async function ArticlePage({ params }: Props) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "Article", headline: post.title, description: post.excerpt, datePublished: post.publishedAt ?? post.scheduledAt, dateModified: post.updatedAt, mainEntityOfPage: url, author: { "@type": "Person", name: post.author }, publisher: { "@type": "Organization", name: "Kivai", url: SITE_URL }, ...(post.cover ? { image: [post.ogImage || post.cover.url] } : {}) };
