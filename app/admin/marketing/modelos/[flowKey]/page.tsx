  ...
  return (
    <div className="space-y-6">
      ...
      <form action={saveMarketingTemplate} className="space-y-5 border border-white/10 bg-card p-6">
        ...
        <label className="grid gap-2 text-sm"><span className="font-medium">Mensagem completa</span><textarea name="message" defaultValue={template.message} required rows={14} maxLength={12000} className="border border-white/10 bg-background p-3 text-foreground" /></label>
